            ...
            <div class="content container-fluid">
                                                    ...
                                                    <div class="selectbox-cont selectbox-cont-one h-auto">
                                                        <div class="date-picker">
                                                            <div class="form-custom cal-icon">
                                                                <input class="form-control datetimepicker" name="from_date" id="from_date" type="text" placeholder="Form">
                                                            </div>
                                                        </div>
                                                        <div class="date-picker pe-0">
                                                            <div class="form-custom cal-icon">
                                                                <input class="form-control datetimepicker" name="to_date" id="to_date" type="text" placeholder="To">
                                                            </div>
                                                        </div>
                                                        <div class="date-list">
                                                            <ul>
                                                                <li><a href="#" class="btn date-btn" onclick="setFilter('today')">Today</a></li>
                                                                <li><a href="#" class="btn date-btn" onclick="setFilter('yesterday')">Yesterday</a></li>
                                                                <li><a href="#" class="btn date-btn" onclick="setFilter('last7')">Last 7 days</a></li>
                                                                <li><a href="#" class="btn date-btn" onclick="setFilter('thismonth')">This month</a></li>
                                                                <li><a href="#" class="btn date-btn" onclick="setFilter('lastmonth')">Last month</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row align-items-center ">
                                <div class="col-lg-8 col-md-8">
                                    <div class="invoices-tabs">
                                        ...
                                        <ul>
                                            <li><a href="invoices.php" class="active">All Invoice</a></li>
                                            <li><a href="invoices-paid.php">Paid</a></li>
                                            <li><a href="invoices-recurring.php">In loading</a></li>
                ...
                function convertCurrency($amount, $currency_from, $currency_to, $rate)
                {
                    ...
                    if ($currency_from === $currency_to) {
                        return number_format((float)$amount, 0, '.', ' ') . ' ' . $currency_to;
                    }
                ...
                // Requête principale (factures + infos client + items)
                            ...
                            <div class="card-body">
                                <div class="inovices-widget-header">
                                    ...
                                    <div class="inovices-dash-count">
                                        <div class="inovices-amount" style="font-size: 18px;"> <?php echo ($totalAmountAll) ?? 0; ?> </div>
                                    </div>
                                </div>
                                <p class="inovices-all" style="display: flex;align-items: center;justify-content: end;">All Invoices <span style="font-size: 16px;"><?php echo $totalInvoices; ?></span></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card inovices-card">
                            <div class="card-body">
                                <div class="inovices-widget-header">
                                    ...
                                    <div class="inovices-dash-count">
                                        <div class="inovices-amount" style="font-size: 18px;"><?php echo ($totalAmountPaid); ?> </div>
                                    </div>
                                </div>
                        ...
                        <div class="card inovices-card">
                            <div class="card-body">
                                <div class="inovices-widget-header">
                                    ...
                                    <div class="inovices-dash-count">
                                        <div class="inovices-amount" style="font-size: 18px;"><?php echo ($unpaidAmountAdvance); ?> </div>
                                    </div>
                                </div>
                                <p class="inovices-all" style="display: flex;align-items: center;justify-content: end;">Unpaid Invoices <span style="font-size: 16px;"><?php echo $unpaidInvoices; ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result_invoices->num_rows > 0) {
                                                while ($invoice = $result_invoices->fetch_assoc()) {
                                                    ...
                                                    if ($edit_disabled) {
                                                        echo "<a class='dropdown-item' href='generate_invoice_pdf.php?id=$invoice_id>'><i class='fas fa-download me-1'></i></i>Download</a>";
                                                    } else {
                                ...
                                <div class="modal-body">
                                    <form id="editOrderForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" step="0.01" type="number" id="amount" name="amount" required>
                                        </div>
